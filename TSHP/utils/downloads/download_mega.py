...
win64_url = "https://megatools.megous.com/builds/experimental/megatools-1.11.0-git-20211030-win64.zip"
win32_url = "https://megatools.megous.com/builds/experimental/megatools-1.11.0-git-20211030-win32.zip"
linux_url = "https://megatools.megous.com/builds/experimental/megatools-1.11.0-git-20211030-linux-x86_64.tar.gz"
...
def megadown(download_link, filename='', verbose=False):
    ...
    wd_old = os.getcwd()
    filename = ' --path "'+os.path.abspath(filename)+'"' if filename else ' --path "'+os.getcwd()+'"'
